...
Examples:
    | directions    | interactions         | beverage      | MoneyBar | EspressoBar  | 
    | Go south      | Enter the cafe       | a can of beer | Money    | espressoCups |
